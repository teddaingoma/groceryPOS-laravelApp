...
<html lang="en">
    <head>
        ...
        <title>{{ $commodity -> name }} | Add Commodity Quantity</title>
    ...
    <body class="add-commodity-body">
        ...
        <div class="add-commodity-form">
            ...
            <div class="form--header">
                ...
                <h1 class="form--title">Add Quantity of {{ $commodity -> name}}</h1>
            </div>

            <div class="add-commodity--body">
                <form class="add-commodity needs-validation" action="{{ route('store_commodity_quantity') }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
