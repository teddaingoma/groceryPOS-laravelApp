                        ...
                        <div class="row g-3">
                            <div class="names row g-3">
                                ...
                                <div class="col-sm-6 form--input-line">
                                    <label for="firstName" class="form-label">Commodity Category:</label>
                                    <input name="commodity_category" type="text" class="form-control" id="firstName" placeholder="In what category does it belong?" value="" required>
