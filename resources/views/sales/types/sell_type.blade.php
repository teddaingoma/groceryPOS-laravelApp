    ...
    @foreach ($Commodity->Types as $Type )
        ...
        @if ($Type->id == $commodity_type_id)
            ...
            <div class="pps-main-content-header">
                ...
                @endif
                <h2 class="pps-main-content-title">Sell {{ $Type->type_name }}</h2>
            </div>
            ...
            <div class="pps-main-content-body">
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="pps-commodities">
                        <div class="commodity">
                            <form action="{{ route('record_sell_type', ['commodity' => $Commodity->id, 'type' => $Type->id]) }}" method="POST" enctype="multipart/form-data" novalidate class="add-commodity needs-validation">
                                @csrf
                                <div class="card">
                                    ...
                                    <div class="card__body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6 form--input-line">
                                                <label for="lastName" class="form-label">Selling Price <span class="text-muted">MWK</span>: {{ $Type->TypePrice->type_price }}</label>
                                            </div>
