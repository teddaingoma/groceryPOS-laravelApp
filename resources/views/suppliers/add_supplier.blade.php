    ...
    <body class="register-body">
        ...
        <div class="register-form">
            ...
            <div class="form--header">
                <h1 class="form--title"> Add Supplier </h1>
            </div>
            ...
            <div class="register--body">
                ...
                <form class="register needs-validation" action="{{ route('add_supplier') }}" method="post" enctype="multipart/form-data" novalidate>
                    @csrf
                            ...
                            <div class="names row g-3">
                                <div class="col-sm-6 form--input-line">
                                    ...
                                    <div class="invalid-feedback">
                                        Enter supplier's' full Name, Please.
                                    </div>
                                </div>
                                <div class="col-sm-6 form--input-line">
                                    <label for="supplier_dp" class="form-label">Image <span class="text-muted">(Optional)</span>:</label>
                                    <input name="supplier_dp" type="file" class="form-control" id="supplier_dp" placeholder="" value="">
                                </div>
