    ...
    <body class="add-commodity-body">
        ...
        <div class="add-commodity-form">
            ...
            <div class="form--header">
                ...
                <h1 class="form--title">Add Unit of {{ $commodity -> name}}</h1>
            </div>

            <div class="add-commodity--body">
                <form class="add-commodity needs-validation" action="{{ route('store_commodity_unit') }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
